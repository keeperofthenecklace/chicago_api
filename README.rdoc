== README
This is a simple lightweight Rails::API project serving JSON resourcess data to a seperate node app "chicago_north".
Chicago_north app (WIP), is a single page application built on Flux, React.js (view) and Angular.js (model & controller)
