== README
This is a simple lightweight Rails::API project serving JSON resources to a seperate node app "chicago_north". Chicago_north app which is not include in my public repository (WIP), is a single page application built on Flux, React.js (view) and Angular.js (model & controller)
