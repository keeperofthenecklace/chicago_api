...
It is a simple Rails application (chicago_api) that serves JSON resources to an API client, frontend (chicago_south).
...
React is used to build the frontend with the flux architecture.
